...
const TDL =
  "bg-gray-100 font-bold text-xs border border-gray-600 px-2 py-1.5 align-middle whitespace-nowrap";
const TH =
  "bg-gray-200 font-bold text-xs text-center border border-gray-600 px-2 py-1";
      ...
      <tbody>
        <tr>
          <td
            className={TDL}
            rowSpan={3}
            style={{ writingMode: "vertical-rl", width: "4%" }}
          >
            {label}
          </td>
          ...
          <td className={TDL} rowSpan={2} style={{ width: "12%" }}>
            서명 또는
            <br />
            날인
          </td>
...
export default function LeaseContractForm({
  ...
  return (
    <div
      className="bg-white font-serif text-[11px] leading-relaxed"
      id="lease-form"
    >
      {/* 체크박스 임대 유형 */}
      ...
      {/* 제목 */}
      <h1 className="text-center text-xl font-black tracking-wide mb-1">
        상가건물 임대차 표준계약서
      </h1>
      ...
      <table className="w-full border-collapse border border-gray-600 mb-4">
        <tbody>
          ...
          <tr>
            ...
            <td className={TDL} style={{ width: "8%" }}>
              지목
            </td>
      ...
      <p className="font-bold text-[12px] mb-1">
        ...
        <span className="font-normal text-[11px]">
          위 상가건물의 임대차에 관하여 임대인과 임차인은 합의에 의하여 보증금과
          차임 및 관리비를 아래와 같이 지급하기로 한다.
        </span>
      </p>
      <table className="w-full border-collapse border border-gray-600 mb-2">
        <tbody>
          <tr>
            <td className={TH} style={{ width: "15%" }}>
              보&nbsp;&nbsp;증&nbsp;&nbsp;금
            </td>
          ...
          <tr>
            ...
            <td className={TDL} style={{ width: "12%" }}>
              수령인
            </td>
          ...
          <tr>
            ...
            <td className={TD} colSpan={3}>
              ...
              {editMode ? (
                <select
                  value={f["부가세_포함여부"] ?? "불포함"}
                  onChange={(e) => onChange("부가세_포함여부", e.target.value)}
          ...
          <tr>
            ...
            <td className={TD} colSpan={3}>
              <span className="text-[10px] text-gray-500">(정액인 경우)</span>
              &nbsp;총액&nbsp;
              <Field
                fk="관리비"
                f={f}
      ...
      <p className="text-[11px] mb-2">
        <strong>제2조(임대차기간)</strong>&nbsp;임대인은 임차 상가건물을 임대차
      ...
      <div className="text-[10px] text-gray-600 border border-gray-300 rounded p-2 mb-3 bg-gray-50">
        <strong>제4조(사용·관리·수선)</strong> 임차인은 임대인의 동의 없이 임차
        상가건물의 구조·용도 변경 및 전대나 임차권 양도를 할 수 없다. /&nbsp;
        <strong>제5조(계약의 해제)</strong> 임차인이 중도금 지급 전까지 임대인은
        계약금의 배액을 상환하고, 임차인은 계약금을 포기하고 계약을 해제할 수
        있다. /&nbsp;
        <strong>제8조(계약의 종료)</strong> 임대차기간 끝나기 6개월 전부터
        임대차 종료 시까지 권리금 회수 방해 금지.
        <br />
        <span className="text-[9px] text-gray-400">
          ※ 제6~12조는 상가건물임대차보호법 표준계약서의 해당 조문을 적용합니다.
        </span>
      </div>
      ...
      <div className="mb-4">
        ...
        <div className="border border-gray-400 rounded min-h-[60px] p-2">
          {editMode ? (
            ...
            <p
              className={`text-xs ${!f["특약사항"] || f["특약사항"] === "[직접 입력]" ? "text-gray-300 italic" : "text-gray-900"}`}
            >
              {f["특약사항"] || "[직접 입력]"}
            </p>
          )}
      ...
      <div className="mt-4 text-[10px] text-red-600 border-t border-gray-200 pt-2">
        ※ 본 초안은 참고용입니다. 실제 계약 전 법무부 표준계약서 원본을 사용하고
        전문가 확인을 권장합니다.
      </div>
    </div>
  );
