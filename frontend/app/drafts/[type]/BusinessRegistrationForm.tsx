...
function YN({
  ...
  return <span className="text-xs">{isYes ? "☑여 □부" : "□여 ☑부"}</span>;
}

/* ─────────────────────────── 공통 스타일 ─────────────────────────── */
const TH =
  "bg-gray-100 text-xs font-semibold text-gray-700 text-center border border-gray-400 px-1 py-1 align-middle whitespace-nowrap";
const TD = "border border-gray-400 px-1.5 py-1 text-xs align-middle";
const TDL =
  "bg-gray-50 text-xs font-semibold text-gray-700 text-center border border-gray-400 px-1 py-1 align-middle whitespace-nowrap";
  ...
  return (
    <div className="bg-white font-sans text-[11px]" id="biz-reg-form">
      ...
      <div className="flex justify-between text-[10px] text-gray-500 mb-1">
        <span>
          ■ 부가가치세법 시행규칙 [별지 제4호서식] &lt;개정 2026. 3. 20.&gt;
        </span>
      ...
      <table className="w-full border-collapse border border-gray-400 mb-0">
        <tbody>
          <tr>
            ...
            <td
              className="border border-gray-400 px-2 py-2 text-center font-black text-base"
              style={{ width: "40%" }}
            >
              사업자등록 신청서
      ...
      <table className="w-full border-collapse border border-gray-400 border-t-0">
        ...
        <thead>
          <tr>
            <th colSpan={5} className={`${TH} text-left px-2`}>
              ① 인적사항
            </th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr>
            <td className={TDL} style={{ fontSize: "10px" }}>
              부동산등기용
              <br />
              등록번호
            </td>
      ...
      <table className="w-full border-collapse border border-gray-400 border-t-0">
        <thead>
          <tr>
            <th colSpan={8} className={`${TH} text-left px-2`}>
              ② 사업장 현황
            </th>
          </tr>
        </thead>
        <tbody>
          {/* 업종 헤더 행 */}
          <tr>
            <td className={TDL} rowSpan={3} style={{ width: "8%" }}>
              업종
            </td>
            <td className={TH} style={{ width: "10%" }}>
              구분
            </td>
            <td className={TH} style={{ width: "18%" }}>
              업태
            </td>
            <td className={TH} style={{ width: "22%" }}>
              종목
            </td>
            <td className={TH} style={{ width: "12%" }}>
              업종코드
            </td>
            <td className={TDL} style={{ width: "10%" }}>
              개업일
            </td>
            <td className={TD} colSpan={2}>
              <Cell
          ...
          <tr>
            <td className={TDL} colSpan={7} style={{ fontSize: "10px" }}>
              임대차명세 (타가인 경우만 작성)
            </td>
          </tr>
          <tr>
            ...
            <td className={TD} colSpan={2}>
              <Cell
                value={f("임대인_주민법인등록번호")}
                editMode={editMode}
                fieldKey="임대인_주민법인등록번호"
                onChange={onChange}
              />
            </td>
          </tr>
          <tr>
            ...
            <td className={TD} colSpan={2}>
              <Cell
                ...
                fieldKey="임대차계약기간"
                onChange={onChange}
                placeholder="예: 2025-01-01 ~ 2027-12-31"
              />
            </td>
          ...
          {/* 투자조합 */}
          <tr>
            <td className={TDL} colSpan={2} style={{ fontSize: "10px" }}>
              투자조합 출자 여부
            </td>
          ...
          <tr>
            ...
            <td className={TD} colSpan={2}>
              <YN
                value={f("간이과세_포기신고여부") || "부"}
                editMode={editMode}
                fieldKey="간이과세_포기신고여부"
                onChange={onChange}
              />
            </td>
          </tr>
          ...
          <tr>
            ...
            <td className={TD}>
              <YN
                value={f("사업장외_송달장소_신청여부") || "부"}
                editMode={editMode}
                fieldKey="사업장외_송달장소_신청여부"
                onChange={onChange}
              />
            </td>
          </tr>
          <tr>
            ...
            <td className={TD} colSpan={5}>
              <YN
                value={f("현금영수증_가입신청여부") || "부"}
                editMode={editMode}
                fieldKey="현금영수증_가입신청여부"
                onChange={onChange}
              />
            </td>
          </tr>
      ...
      <table className="w-full border-collapse border border-gray-400 border-t-0">
        <tbody>
          ...
          <tr>
            <td className={TDL} style={{ width: "14%" }}>
              제출처
            </td>
      ...
      <div className="border border-gray-400 border-t-0 bg-gray-50 px-3 py-1.5 text-[10px] text-gray-600">
        <strong>첨부서류:</strong> 사업허가·등록·신고증 사본(해당자),
        임대차계약서 사본(사업장을 임차한 경우), 동업계약서(공동사업자인 경우)
        등
        <br />
        <strong className="text-red-600">
          ※ 본 초안은 참고용입니다. 실제 제출 전 세무서에서 원본 서식을 사용하여
          주시기 바랍니다.
        </strong>
      </div>
    </div>
