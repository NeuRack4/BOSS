        ...
        <div className="space-y-10 text-sm text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <p>
              ...
              다만, 이용자의 사전 동의가 있거나 법령에 의해 요청되는 경우에는
              예외로 합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              서비스는 보유 기간이 경과하거나 처리 목적이 달성된 경우 지체 없이
              개인정보를 파기합니다. 전자적 파일은 복구 불가능한 방법으로 영구
              삭제하며, 출력물 등 물리적 정보는 파쇄 또는 소각합니다.
            </p>
          </section>
          ...
          <section>
            ...
            <div className="bg-gray-50 rounded-xl px-4 py-3">
              <p>
                개인정보 처리에 관한 업무를 총괄하고, 관련 불만 및 피해 구제를
                처리합니다.
              </p>
              <ul className="mt-2 space-y-1">
                ...
                <li>
                  이메일:{" "}
                  <a
                    href="mailto:amydreamsu@gmail.com"
                    className="text-brand-500 hover:underline"
                  >
                    amydreamsu@gmail.com
                  </a>
                </li>
              </ul>
            </div>
          ...
          <section>
            ...
            <p>
              서비스는 챗봇 대화 내역 유지를 위해 세션
              스토리지(sessionStorage)를 사용합니다. 세션 스토리지에 저장된
              데이터는 브라우저 탭 종료 시 자동 삭제되며, 서버로 전송되지
              않습니다.
            </p>
          </section>
        </div>
