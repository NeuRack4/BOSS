...
from backend.api.routers import health, founders, triggers, drafts, subsidies, tax, location, sales, insights, rag, pdf_forms, expenses, marketing, ocr, menus, sales_items, map as map_router, recommend, hire, menu_analysis, doc_review, blog_upload
...
def create_app() -> FastAPI:
    ...
    app.include_router(blog_upload.router, tags=["marketing"])
